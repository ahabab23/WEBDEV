...
const CentralDatabaseRegistration = () => {
  const [currentProjectId, setCurrentProjectId] = useState('central-database-registration');
...
export default CentralDatabaseRegistration;