...
const StatsSection = () => {
  return (
    <section className="relative mb-0">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 px-4 -mt-30 z-50">
        {/* First Card */}
        <div
          className="relative h-64 bg-cover bg-center rounded-lg overflow-hidden flex items-center justify-center"
          style={{
        ...
        >
          ...
          <div className="relative z-10 text-white text-center px-6">
            <h2 className="text-4xl font-extrabold">
              10 <span className="text-3xl">k</span>
            </h2>
            <h5 className="text-lg font-semibold mt-2">
