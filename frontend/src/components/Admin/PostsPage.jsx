...
//     if (type === "checkbox") {
//       val = checked;
//     } else if (type === "date" && name === "published") {
//       // Convert date input (YYYY-MM-DD) to your formatted string
//       val = dateInputToFormatted(value);
//     } else {
//       val = value;
//     }
...
//             <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-xl overflow-hidden border border-gray-200/80 max-h-[90vh] flex flex-col">
